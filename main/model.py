...
from c2nl.models.gstransformer import GSTransformer
...
class GSTransformerAST(object):
    ...
    def __init__(self, args, src_dict, tgt_dict, state_dict=None):
        ...
        self.network = GSTransformer(self.args, tgt_dict)
    ...
    def update(self, ex):
        ...
        #     ex_weights = None
        # else:
        ex_weights = [1.0]#[self.args.dataset_weights[lang] for lang in ex['language']]
    ...
    def load(filename, new_args=None):
        ...
        return GSTransformerAST(args, src_dict, tgt_dict, state_dict)
    ...
    def load_checkpoint(filename, use_gpu=True):
        ...
        args = saved_params['args']
        model = GSTransformerAST(args, src_dict, tgt_dict, state_dict)
