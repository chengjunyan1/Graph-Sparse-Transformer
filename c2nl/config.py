...
def add_model_args(parser):
    ...
    model.add_argument('--model_type', type=str, default='gtransformer',
                       choices=['gtransformer'],
                       help='Model architecture type')
    model.add_argument('--emsize', type=int, default=512,
                       help='Embedding size if embedding_file is not given')
    model.add_argument('--emb_offset', type=int, default=0,
                       help='Embedding size offset')
    ...
    model.add_argument('--dimrate', type=float, default=1,
                       help='Rate of gat output dim to d_model as embeding compression')
    ...
    model.add_argument('--rpe_size', type=int, default=128,
    ...
    model.add_argument('--rpe_m', type=int, default=0,
                       help='m in PGNN anchor')
    model.add_argument('--rpe_c', type=float, default=1,
    ...
    model.add_argument('--diffuse', type=int, default=0,
                       help='Diffuse attention approximate num')
    model.add_argument('--alpha', type=float, default=0.15,
                       help='Diffuse attention transition prob')
